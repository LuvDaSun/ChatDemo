...
proto.MessageEvent.prototype.getTypeCase = function() {
  return /** @type {proto.MessageEvent.TypeCase} */(jspb.Message.computeOneofCase(this, proto.MessageEvent.oneofGroups_[0]));
};
...
proto.MessageEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.MessageSnapshot.serializeBinaryToWriter
    );
  }
  f = message.getNew();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.MessageNew.serializeBinaryToWriter
    );
  }
};
...
proto.MessageEvent.prototype.getNew = function() {
  return /** @type{?proto.MessageNew} */ (
    jspb.Message.getWrapperField(this, proto.MessageNew, 2));
};
